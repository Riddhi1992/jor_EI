...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques17`='$_POST[question]',`ans17`='$name',`topic_ques17`=CONCAT('$topic', ' - q17'), `date17`=NOW() WHERE `ques17` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq18.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques17`='$_POST[question]',`ans17`='$name',`topic_ques17`=CONCAT('$topic', ' - q17'), `date17`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
