...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques15`='$_POST[question]',`ans15`='$name',`topic_ques15`=CONCAT('$topic', ' - q15'), `date15`=NOW() WHERE `ques15` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq16.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques15`='$_POST[question]',`ans15`='$name',`topic_ques15`=CONCAT('$topic', ' - q15'), `date15`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
