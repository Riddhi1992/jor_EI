...
<?php 
    if(isset($_POST['save'])) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques6`='$_POST[question]',`ans6`='$name', `date6`=NOW() WHERE `ques6` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq07.php';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic']) {
            ...
            $query = "SELECT * FROM `client_data` WHERE `ques6` IS NULL AND `id`='$id'";
            $result = mysqli_query($con, $query);
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques6`='$_POST[question]',`ans6`='$name', `date6`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
