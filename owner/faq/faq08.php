...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques8`='$_POST[question]',`ans8`='$name',`topic_ques08`=CONCAT('$topic', ' - q8'), `date8`=NOW() WHERE `ques8` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq09.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques8`='$_POST[question]',`ans8`='$name',`topic_ques08`=CONCAT('$topic', ' - q8'), `date8`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
