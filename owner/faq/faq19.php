...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques19`='$_POST[question]',`ans19`='$name',`topic_ques19`=CONCAT('$topic', ' - q19'), `date19`=NOW() WHERE `ques19` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq20.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques19`='$_POST[question]',`ans19`='$name',`topic_ques19`=CONCAT('$topic', ' - q19'), `date19`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
