...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques13`='$_POST[question]',`ans13`='$name',`topic_ques13`=CONCAT('$topic', ' - q13'), `date13`=NOW() WHERE `ques13` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq14.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques13`='$_POST[question]',`ans13`='$name',`topic_ques13`=CONCAT('$topic', ' - q13'), `date13`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
