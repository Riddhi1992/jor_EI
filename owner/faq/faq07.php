...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques7`='$_POST[question]',`ans7`='$name',`topic_ques07`=CONCAT('$topic', ' - q7'), `date7`=NOW() WHERE `ques7` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq08.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques7`='$_POST[question]',`ans7`='$name',`topic_ques07`=CONCAT('$topic', ' - q7'), `date7`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
