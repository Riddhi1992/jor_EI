...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques16`='$_POST[question]',`ans16`='$name',`topic_ques16`=CONCAT('$topic', ' - q16'), `date16`=NOW() WHERE `ques16` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq17.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques16`='$_POST[question]',`ans16`='$name',`topic_ques16`=CONCAT('$topic', ' - q16'), `date16`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
