...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques5`='$_POST[question]',`ans5`='$name', `topic_ques05`=CONCAT('$topic', ' - q5'), `date5`=NOW() WHERE `ques5` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq06.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques5`='$_POST[question]',`ans5`='$name',`topic_ques05`=CONCAT('$topic', ' - q5'), `date5`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
