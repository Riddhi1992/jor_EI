...
<?php 
    if(isset($_POST['save'])) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques5`='$_POST[question]',`ans5`='$name', `date5`=NOW() WHERE `ques5` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq06.php';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques5`='$_POST[question]',`ans5`='$name', `date5`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
