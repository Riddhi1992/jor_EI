...
<?php 
    if(isset($_POST['save'])) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques12`='$_POST[question]',`ans12`='$name', `date12`=NOW() WHERE `ques12` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq13.php';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic']) {
            ...
            $query = "SELECT * FROM `client_data` WHERE `ques12` IS NULL AND `id`='$id'";
            $result = mysqli_query($con, $query);
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques12`='$_POST[question]',`ans12`='$name', `date12`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
