...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques12`='$_POST[question]',`ans12`='$name',`topic_ques12`=CONCAT('$topic', ' - q12'), `date12`=NOW() WHERE `ques12` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq13.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques12`='$_POST[question]',`ans12`='$name',`topic_ques12`=CONCAT('$topic', ' - q12'), `date12`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
