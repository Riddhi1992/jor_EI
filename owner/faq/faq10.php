...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques10`='$_POST[question]',`ans10`='$name',`topic_ques10`=CONCAT('$topic', ' - q10'), `date10`=NOW() WHERE `ques10` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq11.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques10`='$_POST[question]',`ans10`='$name',`topic_ques10`=CONCAT('$topic', ' - q10'), `date10`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
