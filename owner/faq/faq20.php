...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques20`='$_POST[question]',`ans20`='$name',`topic_ques20`=CONCAT('$topic', ' - q20'), `date20`=NOW() WHERE `ques20` IS NULL ORDER BY id DESC LIMIT 1";
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques20`='$_POST[question]',`ans20`='$name',`topic_ques20`=CONCAT('$topic', ' - q20'), `date20`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
