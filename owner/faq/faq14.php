...
<?php 
    if(isset($_POST['save']) && $_GET['topic'] && $_GET['option']) {
        ...
        if($result) {
            ...
            $sql = "UPDATE `client_data` SET `ques14`='$_POST[question]',`ans14`='$name',`topic_ques14`=CONCAT('$topic', ' - q14'), `date14`=NOW() WHERE `ques14` IS NULL ORDER BY id DESC LIMIT 1";
            ...
            if($res) {
                echo"
                    <script>
                        ...
                        window.location.href = 'faq15.php?topic=$topic&option=$option';
                    </script>
                ";
            }
        }    
    ...
    if(isset($_POST['update'])) {
        if(isset($_GET['id']) && $_GET['topic'] && $_GET['option']) {
            ...
            if($result) {
                ...
                $sql = "UPDATE `client_data` SET `ques14`='$_POST[question]',`ans14`='$name',`topic_ques14`=CONCAT('$topic', ' - q14'), `date14`=NOW() WHERE `topic`='$topic'";
                $res = mysqli_query($con, $sql);
