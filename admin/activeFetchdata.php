                    ...
                    <div class='col gap-3 m-3'>
                        <div class='card h-100 shadow' style='width: 20rem;'>
                            ...
                            <div class=card-body m-3'>
                                <a class='h4' href='../owner/faq/view_data.php?id=$row[id]&topic=$row[topic]&visCon=$visitor_counter'>$row[topic]</a>&nbsp;
                                ...
                                <button class='btn btn-primary'><a class='text-light text-decoration-none' href='../owner/faq/view_data.php?id=$row[id]&topic=$row[topic]&visCon=$visitor_counter&option=$row[buy_lease]'>Edit <i class='far fa-edit'></i></a></button>&nbsp;
